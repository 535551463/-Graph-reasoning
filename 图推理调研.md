...
| 2015 | IJCNLP | 语义解析 | STAGG |有效地利用了图谱信息对语义解析空间进行了裁剪，简化了语义匹配的难度，同是结合一些人工定义的处理最高级和聚合类问题的模板，具备较强理解复杂问题的能力，该方法提出的语义解析到查询图生成转化的思想称为后续研究的基础| https://arxiv.org/abs/2101.03737 |
